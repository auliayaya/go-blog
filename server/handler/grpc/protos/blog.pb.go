...
func (x *ListBlogResponse) Reset() {
	*x = ListBlogResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protos_blog_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListBlogResponse) Descriptor() ([]byte, []int) {
	return file_protos_blog_proto_rawDescGZIP(), []int{10}
}
...
var file_protos_blog_proto_rawDesc = []byte{
	...
	0x65, 0x30, 0x01, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x61, 0x75, 0x6c, 0x69, 0x61, 0x79, 0x61, 0x79, 0x61, 0x2f, 0x67, 0x6f, 0x2d, 0x62,
	0x6c, 0x6f, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_protos_blog_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_protos_blog_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_blog_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
